...
model = load_model('GDP-Fucose_v7XGSK_PE9XGSK_with_Opt7b_setup.cps')
...
set_objective_function(expression='Values[GDP_Fucose_at_24h]', maximize=True)
...
file_name = "GDP-Fucose_v7XGSK_PE9XGSK_Opt7b_RandParamSampl_EvoStrat100x_list_res_stats.pkl"
