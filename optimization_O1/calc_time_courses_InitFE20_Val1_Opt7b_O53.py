...
# (initial enzyme concentrations from opt. result 'O53'.EvoStrat100x as calculated in
# 'select_best_Opt7b_for_all_param_sets.py'; initial substrate concentrations from FE20_Validation1 experiment)
