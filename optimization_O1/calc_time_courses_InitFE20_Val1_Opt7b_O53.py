...
# set initial concentrations of Alberto FE20_Validation1 experiment [mM]
# (initial enzyme concentrations from opt. result 'O53'.EvoStrat100x as calculated in 'select_best_Opt7b_for_all_param_sets.py'; initial substrate concentrations from FE20_Validation1 experiment)
...
set_species('E_FKP', initial_concentration=0.014910)
set_species('E_PPA', initial_concentration=0.020148)
set_species('E_PPK3', initial_concentration=0.009456)
set_species('E_GMPK', initial_concentration=0.002413)
# FE20_Validation1 is not part of the model file. Therefore, we need to get it from an external text file
...
selected_exp_data = pd.read_table('2023_02_01_FE20_Validation1_withInitConcColumns.txt', sep='\t', header=0)
# load standard deriatives
selected_exp_data_SD = pd.read_table('2023_02_01_FE20_Validation1_SD.txt', sep='\t', header=0)
...
file_name = "GDP-Fucose_v7XGSK_PE9XGSK_EvoStrat100x_TCSimResults_InitFE20_Val1_Opt7b_O53.pkl"
