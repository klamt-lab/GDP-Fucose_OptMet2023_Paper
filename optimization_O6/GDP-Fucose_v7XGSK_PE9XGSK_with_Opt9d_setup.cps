...
<!-- generated with COPASI 4.38 (Build 268) (http://www.copasi.org) at 2023-05-10T13:47:00Z -->
...
<rdf:Description rdf:about="#ModelValue_4">
      ...
      <ModelValue key="ModelValue_5" name="Substrate_Weighted_Cost" simulationType="assignment" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
structure of the terms: price * mmol/l concentration * MW in g/mmol
...
<rdf:Description rdf:about="#ModelValue_9">
      ...
      <ModelValue key="ModelValue_10" name="Enzyme_Weighted_Cost" simulationType="assignment" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
-> unit of the toal weighted sum will be: (Euros/g)*(mmol/l)*(g/mmol) = Euros/l
      ...
      <ModelValue key="ModelValue_11" name="Fixed_Cost" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#ModelValue_12">
        ...
        <Expression>
          (&lt;CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Values[Enzyme_Weighted_Cost],Reference=InitialValue>+&lt;CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Values[Substrate_Weighted_Cost],Reference=InitialValue>+&lt;CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Values[Fixed_Cost],Reference=InitialValue>)/&lt;CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Values[GDP-Fucose at 24h],Reference=Value>
        </Expression>
      </ModelValue>
...
<rdf:Description rdf:about="#ModelValue_13">
      ...
      <ModelValue key="ModelValue_14" name="Profit" simulationType="assignment" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#ModelValue_14">
      ...
      <ModelValue key="ModelValue_15" name="Cost" simulationType="assignment" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#ModelValue_15">
        ...
        <Expression>
          &lt;CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Values[Enzyme_Weighted_Cost],Reference=InitialValue>+&lt;CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Values[Substrate_Weighted_Cost],Reference=InitialValue>+&lt;CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Values[Fixed_Cost],Reference=InitialValue>
        </Expression>
      </ModelValue>
      <ModelValue key="ModelValue_16" name="Income" simulationType="assignment" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Values[Substrate_Weighted_Cost]" value="27.764701219999999" type="ModelValue" simulationType="assignment"/>
          ...
          <ModelParameter cn="CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Values[Enzyme_Weighted_Cost]" value="300.74952926938772" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Values[Fixed_Cost]" value="500" type="ModelValue" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Values[Profit]" value="-0.16570284609787755" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Values[Cost]" value="828.51423048938773" type="ModelValue" simulationType="assignment"/>
    ...
    <InitialState type="initialState">
      0 0 3.6132845141999999e+21 0 0 0 0 0 1.5476902002489999e+22 0 1.5476902002489999e+22 0.046928797000000001 NaN NaN 27.764701219999999 NaN 57.399999999999999 300.74952926938772 INF 1.550000078664 -0.16570284609787755 828.51423048938773 0 1.8709081354695614e+19 1.7334889032536783e+18 3.9896827709005578e+18 3.8289295495060562e+18 1 0 0 0 0 500 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_21" name="Optimization" type="optimization" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <ParameterText name="ObjectiveExpression" type="expression">
          &lt;CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Values[Cost_per_Product],Reference=Value>
        </ParameterText>
        ...
        <ParameterGroup name="OptimizationItemList">
          ...
          <ParameterGroup name="OptimizationItem">
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Compartments[compartment],Vector=Metabolites[ATP],Reference=InitialConcentration"/>
            <Parameter name="LowerBound" type="cn" value="0"/>
            <Parameter name="UpperBound" type="cn" value="20"/>
            <Parameter name="StartValue" type="float" value="6"/>
          </ParameterGroup>
          <ParameterGroup name="OptimizationItem">
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Compartments[compartment],Vector=Metabolites[Fuc],Reference=InitialConcentration"/>
            <Parameter name="LowerBound" type="cn" value="0"/>
            <Parameter name="UpperBound" type="cn" value="40"/>
            <Parameter name="StartValue" type="float" value="25.699999999999999"/>
          </ParameterGroup>
          <ParameterGroup name="OptimizationItem">
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Compartments[compartment],Vector=Metabolites[GMP],Reference=InitialConcentration"/>
            <Parameter name="LowerBound" type="cn" value="0"/>
            <Parameter name="UpperBound" type="cn" value="40"/>
            <Parameter name="StartValue" type="float" value="25.699999999999999"/>
          </ParameterGroup>
