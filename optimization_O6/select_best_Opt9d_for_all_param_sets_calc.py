...
for index, param_set in tqdm(param_sets.iterrows()):
    ...
    for opt_result in opt_result_sets:
        ...
        # append the cost per product to the row of costs per product (= contains cost per products for all different optimization results and one parameter set)
...
# idea: for each column calculate 'col_median/overall_min_median + col_min/overall_min_min + col_sum/overall_min_sum = score'; minimum score (and best score): 3; higher score value = worse score!
