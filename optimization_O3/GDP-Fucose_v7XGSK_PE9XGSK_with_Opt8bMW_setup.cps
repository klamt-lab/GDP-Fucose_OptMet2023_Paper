...
<!-- generated with COPASI 4.38 (Build 268) (http://www.copasi.org) at 2023-05-10T09:31:09Z -->
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_13">
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_0" name="GDP_Fucose_at_40h" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
        ...
        <ListOfAssignments>
          <Assignment target="CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Values[GDP_Fucose_at_40h]" targetKey="ModelValue_0">
            <Expression>
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Compartments[compartment],Vector=Metabolites[E_FKP]" value="3.9896827709005573e+18" type="Species" simulationType="reactions"/>
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Values[GDP_Fucose_at_40h]" value="0" type="ModelValue" simulationType="fixed"/>
    ...
    <InitialState type="initialState">
      0 0 3.6132845141999999e+21 0 0 0 0 0 1.5476902002489999e+22 0 1.5476902002489999e+22 0.046928797000000001 NaN NaN 27.764701219999999 NaN 57.399999999999999 300.74952926938772 INF 1.550000078664 1.8709081354695614e+19 1.7334889032536783e+18 3.9896827709005573e+18 3.8289295495060562e+18 1 0 0 0 0 500 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_21" name="Optimization" type="optimization" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <ParameterText name="ObjectiveExpression" type="expression">
          &lt;CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Values[E_tot_MW],Reference=Value>
        </ParameterText>
        ...
        <ParameterGroup name="OptimizationItemList">
          ...
          <ParameterGroup name="OptimizationItem">
            ...
            <Parameter name="StartValue" type="float" value="0.031067160000000003"/>
          </ParameterGroup>
          <ParameterGroup name="OptimizationItem">
        ...
        <ParameterGroup name="OptimizationConstraintList">
          ...
          <ParameterGroup name="OptimizationItem">
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=GDP-Fucose_v7XGSK,Vector=Values[GDP_Fucose_at_24h],Reference=Value"/>
            <Parameter name="LowerBound" type="cn" value="15"/>
            <Parameter name="UpperBound" type="cn" value="inf"/>
            <Parameter name="StartValue" type="float" value="12.81660265"/>
          </ParameterGroup>
        </ParameterGroup>
      </Problem>
