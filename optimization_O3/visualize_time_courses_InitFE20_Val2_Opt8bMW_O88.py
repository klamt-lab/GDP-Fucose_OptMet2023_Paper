...
# LOAD DATA
# load sim_results
pickle_file = open("GDP-Fucose_v7XGSK_PE9XGSK_EvoStrat100x_TCSRes_InitFE20_Val2_Opt8bMW_O88.pkl", "rb")
sim_results = pickle.load(pickle_file)
pickle_file.close()
# load FE20_Val2 experimental data for plotting
selected_exp_data = pd.read_csv('2023_02_01_FE20_Validation2_withInitConcColumns.txt', sep='\t')
selected_exp_data_SD = pd.read_csv('2023_02_01_FE20_Validation2_SD.txt', sep='\t')
...
# OUTPUT
# save plot as .pdf
plt.savefig("GDP-Fucose_v7XGSK_PE9XGSK_EvoStrat100x_TCs_InitFE20_Val2_fig.pdf")
# save plot as .png (for Word)
plt.savefig("GDP-Fucose_v7XGSK_PE9XGSK_EvoStrat100x_TCs_InitFE20_Val2_fig.png")
# save plot as .svg (for Word)
plt.savefig("GDP-Fucose_v7XGSK_PE9XGSK_EvoStrat100x_TCs_InitFE20_Val2_fig.svg")